...
export const About = ({ settings }: { settings: SiteSettingsView }) => {
  const facts = [
    /* Read out of `settings.hours`, not typed out: the fact used to say "7/7
       днів на тиждень" while the footer, the hero and the JSON-LD all said
       Чт–Сб. The hours themselves come from the admin panel now. */
