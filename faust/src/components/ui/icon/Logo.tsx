...
export const Logo = ({ title = "Faust", ...props }: LogoProps) => (
  <svg viewBox="0 0 132 32" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label={title} {...props}>
    <defs>
    ...
    <text x="34" y="24" fill="currentColor" fontFamily="var(--font-display, sans-serif)" fontWeight="700" fontSize="21" letterSpacing="0.5">
      FAUST
    </text>
  </svg>
);
